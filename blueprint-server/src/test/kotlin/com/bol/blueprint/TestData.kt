...
import com.bol.blueprint.TestData.v100
import com.bol.blueprint.TestData.v101
import com.bol.blueprint.TestData.v200snapshot
...
object TestData {
    ...
    val v100 = VersionKey(UUID.randomUUID())
    val v101 = VersionKey(UUID.randomUUID())
    val v200snapshot = VersionKey(UUID.randomUUID())
...
suspend fun CommandHandler.applyBasicTestSet() {
    ...
    createVersion(ns1_schema1, v100, "1.0.0")
    createVersion(ns1_schema1, v101, "1.0.1")
    createVersion(ns1_schema1, v200snapshot, "2.0.0-SNAPSHOT")

    createArtifact(v100, artifact1, "artifact1.json", MediaType.JSON, byteArrayOf(1, 2, 3))
    createArtifact(v100, artifact2, "artifact2.json", MediaType.JSON, byteArrayOf(4, 5, 6))
}
