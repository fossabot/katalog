...
data class RegistryState(
    ...
    internal val namespaces: MutableMap<NamespaceId, Namespace> = mutableMapOf(),
    internal val schemas: MutableMap<SchemaId, SchemaEntry> = mutableMapOf(),
    internal val versions: MutableMap<VersionId, VersionEntry> = mutableMapOf(),
    internal val artifacts: MutableMap<ArtifactId, ArtifactEntry> = mutableMapOf()
) : State() {
